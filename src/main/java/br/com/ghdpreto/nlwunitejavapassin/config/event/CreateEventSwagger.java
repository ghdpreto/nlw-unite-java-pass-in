...
@Operation(description = "Essa função é responsável por registrar um novo evento")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "201",
                description = "Evento criado",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = EventIdDTO.class))),
        @ApiResponse(
                responseCode = "400",
...
public @interface CreateEventSwagger {
}
