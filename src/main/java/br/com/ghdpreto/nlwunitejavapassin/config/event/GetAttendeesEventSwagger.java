...
@Operation(description = "Essa função é responsável por listar todos os participantes de um evento")
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = AttendeesListResponseDTO.class))),
        @ApiResponse(
                responseCode = "400",
...
public @interface GetAttendeesEventSwagger {
}
